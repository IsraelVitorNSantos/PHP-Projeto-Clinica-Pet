    ...
    class Pet {
        ...
        public function cadastrar() {
            ...
            if ($this -> getIdCliente() != null) {
                ...
                return $this -> utilidades -> validaRedirecionar($retorno, $id, "admin.php?rota=visualizar_pet", "Pet cadastrado com sucesso!");
            }
            else {
        ...
        public function deletar($id) {
            ...
            $this -> retornoBD = $this -> conexaoBD -> query($sql);
            $this -> utilidades -> validaRedirecionaAcaoDeletar($this -> retornoBD, 'admin.php?rota=visualizar_pet', 'Pet deletado com sucesso!');
        }
    }